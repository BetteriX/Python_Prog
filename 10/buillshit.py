...
def get_buillshit():
    ...
    szoveg1 = random.choice(string_arr1)
    szoveg2 = random.choice(string_arr2)
    szoveg3 = random.choice(string_arr3)
    szoveg4 = random.choice(string_arr4)

    result = szoveg1 + " " + szoveg2 + " " + szoveg3 + " " + szoveg4 + "."
